...
class RestauranModel {
    ...
    factory RestauranModel.fromRawJson(String str) => RestauranModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory RestauranModel.fromJson(Map<String, dynamic> json) => RestauranModel(
